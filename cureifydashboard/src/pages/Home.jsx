        ...
        <div className='nabarwithmain'>
            ...
            <div className='mainBar'>
                ...
                >
                    ...
                    <input className='searchcont' type="text" placeholder='Search' />
                </motion.div>

                <motion.div
                    className='forstatCards'
                    variants={fadeUp} initial="hidden" whileInView="visible"
                    transition={{ duration: 0.6, delay: 0.1 }} viewport={vp}
                >
                    <StatisticCard stattitle="App downloads" statnumber="20" />
                    <StatisticCard stattitle="Total Users" statnumber="2" />
                    <StatisticCard stattitle="Features" statnumber="5" />
                    <StatisticCard stattitle="Pharmacy Orders" statnumber="430" />
                </motion.div>
                        ...
                        >
                            <div className='panelHeader'>
                                ...
                                <Link to="/orders" style={{ textDecoration: "none" }}>
                                    <div className='panelViewAll'>View All</div>
                                </Link>
                            </div>
                            ...
                            <div className='dashboardRow'>
                                ...
                                <div className='rowRight'>
                                    <span className='rowAmount'>145.00 EGP</span>
